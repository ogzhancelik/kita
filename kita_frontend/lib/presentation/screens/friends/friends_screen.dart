...
class _FriendsScreenState extends State<FriendsScreen>
  ...
  void _inviteFriendToMatch(
    ...
    showDialog(
      context: context,
      builder: (ctx) => _FriendChallengeDialog(
        friend: friend,
...
class _FriendChallengeDialog extends StatefulWidget {
  final FriendItemModel friend;
  final OnlineGameProvider onlineProv;

  const _FriendChallengeDialog({
    required this.friend,
    required this.onlineProv,
  });

  @override
  State<_FriendChallengeDialog> createState() => _FriendChallengeDialogState();
}

class _FriendChallengeDialogState extends State<_FriendChallengeDialog> {
  int _selectedTimeControl = TimeControlPreset.threeMin;
  String _selectedColor = 'random'; // 'random', 'white', 'black'
