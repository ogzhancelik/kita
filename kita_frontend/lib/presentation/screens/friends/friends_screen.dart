  ...
  void _inviteFriendToMatch(
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: Text('online.sendInvite'.tr()),
        content: Text('${friend.username} (Rating: ${friend.rating})'),
        actions: [
          TextButton(
          ...
          ElevatedButton(
            onPressed: () {
              ...
              onlineProv.inviteToMatch(friend.userId, timeControl: TimeControlPreset.threeMin);
