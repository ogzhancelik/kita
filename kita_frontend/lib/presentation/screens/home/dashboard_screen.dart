          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                    ...
                    children: [
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              border: Border.all(color: avatarItem.accentColor, width: 2.5),
                            ),
                            child: Icon(
                              avatarItem.icon,
                      ...
                      if (!isGuest && user != null) ...[
                        ...
                        Row(
                          ...
                          children: [
                            _buildStatColumn('dashboard.totalGames'.tr(), '${user.totalGames}', isDark),
                            _buildStatColumn('dashboard.winRate'.tr(), '${user.winRate.toStringAsFixed(1)}%', isDark),
                            _buildStatColumn('dashboard.rating'.tr(), '${user.rating}', isDark),
                          ],
                        ),
                      ],
                    ],
                ...
                if (isGuest) ...[
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(color: AppColors.guestOrange.withValues(alpha: 0.3)),
                    ),
                    child: Row(
                      children: [
                        const Icon(Icons.info_outline_rounded, color: AppColors.guestOrange, size: 20),
                ...
                // --- 3. Quick Play & Game Modes Section ---
                Text(
                ...
                // Mode 4: Friends & Direct Challenges (GATED FOR GUEST!)
                _buildModeCard(
                  context: context,
                ...
                Row(
                  children: [
                    ...
                    if (isGated) ...[
                      ...
                      const Icon(Icons.lock_rounded, size: 14, color: AppColors.guestOrange),
                    ],
                    if (badgeText != null) ...[
                      const SizedBox(width: 8),
                      Container(
